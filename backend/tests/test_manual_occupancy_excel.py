...
def _booking(**overrides):
    base = {
        ...
        "is_org": True, "guest_name": "Test Guest", "aadhaar_number": "1234-5678-9012",
...
def test_workbook_rows_and_totals():
    bookings = [
        ...
        _booking(booking_number="BKTEST2", is_org=False,
                  ...
                  extra_beds=1, guest_name="Second Guest", aadhaar_number="9999"),
    ]
    ...
    assert ws["E3"].value == "1234-5678-9012"
